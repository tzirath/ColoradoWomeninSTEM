...
export default async function AdminPage() {
  ...
  const [
    ...
    getSupabaseAdmin().from("members").select("*").order("created_at", { ascending: false }).then((res) => { if (res.error) console.error("[admin] members fetch error:", res.error); return res; }),
  ]);
